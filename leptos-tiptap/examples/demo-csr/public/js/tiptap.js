...
export function create(id, content, editable, onChange, onSelection) {
	...
	if (myElem == null) {
		console.error(
			'Can not create Tiptap instance on element with id "' +
				id +
				'", as element could not be found. You may have executed this function when the element was not yet mounted to the DOM.',
		);
	}
